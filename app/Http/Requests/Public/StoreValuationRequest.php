...
class StoreValuationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'municipality' => ['nullable', Rule::in(array_keys(app(SupportedValuationLocations::class)->municipalitiesForState($this->input('state') ?: 'Morelos')))],
            'neighborhood' => ['nullable', 'string', 'max:120'],
            'locality' => ['nullable', 'string', 'max:120'],
            'postal_code' => ['nullable', 'string', 'max:10'],
            'postal_settlement_id' => ['nullable', 'integer'],
            'state' => ['nullable', Rule::in(['Morelos', 'Ciudad de México'])],
    ...
    public function messages(): array
    {
        return [
            ...
            'state.in' => 'Selecciona un estado disponible para el valuador.',
