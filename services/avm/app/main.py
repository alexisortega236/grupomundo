...
def predict_v2_residential():
    ...
    return jsonify({
        ...
        "market": {
            ...
            "municipality_candidate_count": market.get("municipality_candidate_count"),
            "score_threshold_count": market.get("score_threshold_count"),
            "municipality_score_threshold_count": market.get("municipality_score_threshold_count"),
            "accepted_candidate_count": market.get("accepted_candidate_count"),
            "municipality_accepted_count": market.get("municipality_accepted_count"),
            "municipality_both_areas_within_20pct_count": market.get("municipality_both_areas_within_20pct_count"),
            "municipality_both_areas_within_30pct_count": market.get("municipality_both_areas_within_30pct_count"),
            "qualified_count": market.get("qualified_count"),
            "high_quality_count": market.get("high_quality_count"),
            "medium_quality_count": market.get("medium_quality_count"),
            "mean_quality_score": market.get("mean_quality_score"),
            "median_quality_score": market.get("median_quality_score"),
            "max_quality_score": market.get("max_quality_score"),
            "same_neighborhood_count": market.get("same_neighborhood_count"),
            "same_ageb_count": market.get("same_ageb_count"),
            "within_1km_count": market.get("within_1km_count"),
            "within_2km_count": market.get("within_2km_count"),
            "both_areas_within_20pct_count": market.get("both_areas_within_20pct_count"),
            "both_areas_within_30pct_count": market.get("both_areas_within_30pct_count"),
